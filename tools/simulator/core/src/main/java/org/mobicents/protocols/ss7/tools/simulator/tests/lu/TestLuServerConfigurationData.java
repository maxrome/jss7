 ...
 *
 */
public class TestLuServerConfigurationData {
    ...
    protected static final String HLR_ADDRESS = "hlrAddress";
...
//    }
    ...
    */
    ...
    protected static final XMLFormat<TestLuServerConfigurationData> XML = new XMLFormat<TestLuServerConfigurationData>(
            TestLuServerConfigurationData.class) {

        public void write(TestLuServerConfigurationData srv, OutputElement xml) throws XMLStreamException {
            ...
            xml.add(srv.hlrAddress, HLR_ADDRESS, String.class);
        ...
        public void read(InputElement xml, TestLuServerConfigurationData srv) throws XMLStreamException {
            ...
            srv.hlrAddress = (String) xml.get(HLR_ADDRESS, String.class);
