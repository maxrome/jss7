 ...
 *
 */
public class TestLuServerStandardManMBean extends StandardMBean {

    public TestLuServerStandardManMBean(TestLuServerMan impl, Class<TestLuServerManMBean> intf)
