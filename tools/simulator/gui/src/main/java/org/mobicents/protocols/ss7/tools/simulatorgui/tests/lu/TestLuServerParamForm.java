...
package org.mobicents.protocols.ss7.tools.simulatorgui.tests.lu;
 ...
 *
 */
public class TestLuServerParamForm extends JDialog {
    private static final long serialVersionUID = 8609564738597978249L;
    ...
    public TestLuServerParamForm(JFrame owner) {
        ...
        */
        ...
        JLabel lblHLRNumber = new JLabel("HLR Number address string");
        lblHLRNumber.setBounds(10, 147, 339, 14);
        panel.add(lblHLRNumber);

        tbHLRAddress = new JTextField();
        tbHLRAddress.setColumns(10);
        tbHLRAddress.setBounds(367, 144, 154, 20);
        panel.add(tbHLRAddress);
    ...
    public void setData(TestLuServerManMBean luServer) {
    ...
    private void reloadData() {
        ...
        M3uaForm.setEnumeratedBaseComboBox(cbAddressNature, this.luServer.getAddressNature());
        M3uaForm.setEnumeratedBaseComboBox(cbNumberingPlan, this.luServer.getNumberingPlan());
        M3uaForm.setEnumeratedBaseComboBox(cbMapProtocolVersion, this.luServer.getMapProtocolVersion());
        //M3uaForm.setEnumeratedBaseComboBox(cbTypeOfNumber, this.luServer.getTypeOfNumber());
        //M3uaForm.setEnumeratedBaseComboBox(cbNumberingPlanIdentification, this.luServer.getNumberingPlanIdentification());
        //M3uaForm.setEnumeratedBaseComboBox(cbSmsCodingType, this.luServer.getSmsCodingType());

        tbHLRAddress.setText(this.luServer.getHLRAddress());
        tbHlrSsn.setText(((Integer) this.luServer.getHlrSsn()).toString());
        //tbVlrSsn.setText(((Integer) this.luServer.getVlrSsn()).toString());
        //cbSendSrsmdsIfError.setSelected(this.luServer.isSendSrsmdsIfError());
        //cbGprsSupportIndicator.setSelected(this.luServer.isGprsSupportIndicator());
    ...
    private boolean saveData() {
        ...
        this.luServer.setAddressNature((AddressNatureType) cbAddressNature.getSelectedItem());
        this.luServer.setNumberingPlan((NumberingPlanMapType) cbNumberingPlan.getSelectedItem());
        this.luServer.setMapProtocolVersion((MapProtocolVersion) cbMapProtocolVersion.getSelectedItem());
        this.luServer.setTypeOfNumber((TypeOfNumberType) cbTypeOfNumber.getSelectedItem());
        this.luServer.setNumberingPlanIdentification((NumberingPlanIdentificationType) cbNumberingPlanIdentification
                .getSelectedItem());
        this.luServer.setSmsCodingType((SmsCodingType) cbSmsCodingType.getSelectedItem());

        this.luServer.setServiceCenterAddress(tbServiceCenterAddress.getText());
        this.luServer.setHlrSsn(hlrSsn);
        this.luServer.setVlrSsn(vlrSsn);
        this.luServer.setSendSrsmdsIfError(cbSendSrsmdsIfError.isSelected());
        this.luServer.setGprsSupportIndicator(cbGprsSupportIndicator.isSelected());
        */
